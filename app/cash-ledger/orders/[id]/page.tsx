...
export default function OrderDetailsPage() {
  ...
  const { data: transactions, loading: transactionsLoading } =
    useTransactionsByOrderId(orderId);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          {order.status === "active" && (
            <Button onClick={() => handleCloseOrder()}>Mark as Closed</Button>
          )}
          {order.status === "closed" && (
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    the order and all associated transactions.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="paymentMethod">Pick a Date *</Label>
                  <Popover>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All payments and refunds for this order
          </CardDescription>
        </CardHeader>
        <CardContent>
          {transactionsLoading ? (
                ...
                <TableBody>
                  {transactions.map((transaction) => (
                    <TableRow key={transaction.id}>
                      ...
                      <TableCell className="text-right bold">
